...
Item {
    ...
    function handleCmdResponse(text) {
        ...
        if (body.startsWith("model=")) {
            ...
            if (p === "<none>") {
                ...
                root.activePromptLabel = "";
                appendMessage("System", "System prompt cleared.");
            } else {
                root.activeSystemPrompt = p;
                let match = root.promptPresets.find(pr => pr.prompt === p);
                root.activePromptLabel = match ? match.label : p.slice(0, 40) + (p.length > 40 ? "…" : "");
    ...
    StyledRect {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                StyledDropDown {
                    ...
                    onCurrentIndexChanged: {
                        if (!initialChatSelected) return;
                        if (currentIndex < 0 || currentIndex >= chatListModel.count) return;
            ...
            StyledRect {
                ...
                visible: root.activeSystemPrompt.length > 0
                ...
                RowLayout {
                    ...
                    StyledText {
                        Layout.fillWidth: true
                        text: root.activePromptLabel.length > 0 ? root.activePromptLabel : root.activeSystemPrompt
                            ...
                            Repeater {
                                ...
                                delegate: StyledRect {
                                    ...
                                    RowLayout {
                                        ...
                                        StyledText { visible: modelName === Zenith.currentModel; text: "active"; font.pixelSize: Metrics.fontSize(11); opacity: 0.5 }
                                    }
                                    MouseArea {
                            ...
                            Repeater {
                                ...
                                delegate: StyledRect {
                                    ...
                                    RowLayout {
                                        ...
                                        StyledText { visible: presetPrompt === root.activeSystemPrompt; text: "active"; font.pixelSize: Metrics.fontSize(11); opacity: 0.5 }
                                    }
                                    MouseArea {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    StyledButton {
                        ...
                        onClicked: {
                            let oldPath = FileUtils.trimFileProtocol(Directories.config) + "/zenith/chats/" + chatSelector.currentText + ".txt";
                            let newPath = FileUtils.trimFileProtocol(Directories.config) + "/zenith/chats/" + renameInput.text.trim() + ".txt";
                            FileUtils.renameFile(oldPath, newPath, function(success) {
                                if (success) {
                                    chatListModel.set(chatSelector.currentIndex, { "name": renameInput.text.trim() });
                                    Zenith.currentChat = renameInput.text.trim();
                                    renameDialog.close();
                                }
                            });
                        }
    ...
    ListModel {
        ...
        function update(input) {
            ...
            for (let item of root.slashCommands)
    ...
    ListModel {
        ...
        function update(input) {
            ...
            for (let m of root.availableModels)
    ...
    ListModel {
        ...
        function update(input) {
            ...
            for (let p of root.promptPresets)
    ...
    Connections {
        ...
        function onChatsListed(text) {
            ...
            if (!initialChatSelected) { selectDefaultChat(); initialChatSelected = true; }
        }
